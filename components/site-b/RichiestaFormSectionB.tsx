...
import { RichiestaForm } from "@/components/site/RichiestaForm";

/**
 * Form della variante 1b: colonna singola centrata (max-width 880px),
 * non a due colonne come in 1a.
 */
export async function RichiestaFormSectionB() {
  const escursioni = await getProssimeEscursioni(8);

  return (
    <section
      id="richiesta"
      className="bg-page px-5 py-16 sm:px-8 lg:px-14 lg:py-20 scroll-mt-20"
    >
      <div className="mx-auto max-w-[880px]">
        ...
        <p className="mt-4.5 max-w-[620px] text-[17px] leading-relaxed text-ink-soft">
        ...
        <div className="mt-9 shadow-raised rounded-card">
